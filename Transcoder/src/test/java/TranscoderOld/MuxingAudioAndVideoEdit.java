...
public class MuxingAudioAndVideoEdit extends Login {
	WebDriver driver;
	public MuxingAudioAndVideoEdit(WebDriver driver) {
		super(driver);
	}
...
//		By locator = By.xpath("By.xpath("//input[@placeholder='Enter Destination Path']");
		
//		By locator = By.xpath("//input[@placeholder='Enter Destination Path']");
